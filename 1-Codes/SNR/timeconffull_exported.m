    ...
    methods (Access = private)
        ...
        function RunPixelWiseAnalysisButtonPushed(app, event)
            ...
            if app.GenerateHeatmapandHistogramCheckBox.Value
                ...
                ax = gca;
                exportgraphics(ax,strcat(selpath, "/", app.Title(1:end-4), "dff.png"),'Resolution',600);
                ...
                hold off
                ax = gca;
                exportgraphics(ax,strcat(selpath, "/", app.Title(1:end-4), "probdistr.png"),'Resolution',600)
                ...
                ax = gca;
                exportgraphics(ax,strcat(selpath, "/", app.Title(1:end-4), "snr.png"),'Resolution',600)
            end
        end
